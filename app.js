...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var theSum = sum(a,b);
  console.log(theSum[0]);
  var theSum2 = sum(theSum[0],c);
  console.log(theSum2[0]);
  var theMult = multiply(a,b);
  var theMult2 = multiply(theMult[0],c);
...
// TODO: DONE!! Here is the test for sumAndMultiply(); uncomment it to run it
...
function sumArray(testArray){ //eslint-disable-line
  var thisSum = sum(testArray[0],testArray[1]);
  console.log(thisSum);
  var thisSum2 = sum(thisSum[0],testArray[2]);
...
// TODO: DONE!! Here is the test for sumArray(); uncomment it to run it
...
function multiplyArray(testArray){ //eslint-disable-line
  var thisMult = multiply(testArray[0],testArray[1]);
  console.log(thisMult);
  var thisMult2 = multiply(thisMult[0],testArray[2]);
